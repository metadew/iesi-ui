...
export enum StateChangeNotification {
    ...
    CONSTANTS_ENVIRONMENT_TYPES = 'CONSTANTS.ENVIRONMENT_TYPES',
    ...
    LIST_FILTER_ENVIRONMENTS = 'LIST_FILTER.ENVIRONMENTS',
    ...
    IAM_USER_DETAIL_PASSWORD = 'IAM_USERS.DETAIL_PASSWORD',
